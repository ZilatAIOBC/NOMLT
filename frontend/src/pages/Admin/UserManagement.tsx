...
export default function UserManagement() {
  ...
  // open credit modal
  const openChangeCredits = (u: User) => {
    setCreditsUser({
      id: u.id,
      name: u.name,
      email: u.email,
          ...
          {loading ? (
            ...
            <table className="w-full min-w-[800px]">
              <thead className="bg-[#0F0F0F] border-b border-white/10">
                <tr>
                  <th className="text-left px-3 md:px-6 py-4 text-gray-400 font-medium text-sm min-w-[120px]">
                    NAME
                  </th>
                  <th className="text-left px-3 md:px-6 py-4 text-gray-400 font-medium text-sm min-w-[180px]">
                    EMAIL
                  </th>
                  <th className="text-left px-3 md:px-6 py-4 text-gray-400 font-medium text-sm min-w-[80px]">
                    ROLE
                  </th>
                  <th className="text-left px-3 md:px-6 py-4 text-gray-400 font-medium text-sm min-w-[80px]">
                    STATUS
                  ...
                  <th className="text-left px-3 md:px-6 py-4 text-gray-400 font-medium text-sm min-w-[100px]">
                    JOIN DATE
                  </th>
                  <th className="text-left px-3 md:px-6 py-4 text-gray-400 font-medium text-sm min-w-[80px]">
                    ACTIONS
