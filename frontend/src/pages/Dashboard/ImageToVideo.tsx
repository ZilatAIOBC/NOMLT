...
import {
  ...
  uploadImageToUrl,
  ImageToVideoRequest,
} from "../../services/imageToVideoService";
...
const ImageToVideo: React.FC = () => {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      const imageUrl =
        prefilledImageUrl ||
        (imageFile ? await uploadImageToUrl(imageFile) : null);
      if (!imageUrl) {
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-sm text-gray-300">
                          Using image from previous generation
                        </div>
                      </div>
                      <div className="text-xs text-gray-400">
                        Click below to replace with another image.
                      </div>
                    </div>
                  ) : null}
                  <div className="mt-2">
