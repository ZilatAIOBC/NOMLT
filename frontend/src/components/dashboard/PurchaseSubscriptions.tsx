...
const PurchaseSubscriptions: React.FC = () => {
  ...
  const handlePlanAction = async (
    ...
    try {
      ...
      if (!selectedPlan) {
        toast.error(
          "Selected plan not found. Please refresh the page and try again."
        );
        setProcessingPlanId(null);
        return;
      }
      ...
      if (!priceId) {
        toast.error(
          `${selectedPlan.display_name} plan is not configured for ${interval} billing. Please contact support.`
        );
        setProcessingPlanId(null);
        return;
      }
      ...
      if (currentSubscription && isDowngrade) {
        ...
        toast.loading(`Preparing ${actionText} checkout...`, {
          id: "checkout-prep",
        });
              ...
              >
                ...
                {(() => {
                  ...
                  return (
                    <button
                      onClick={() =>
                        handlePlanAction(plan.id, isUpgrade, isDowngrade)
                      }
