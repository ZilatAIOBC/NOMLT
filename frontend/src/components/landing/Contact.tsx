...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-900 via-blue-900/10 to-purple-900/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Have questions about LMT.ai? We'd love to hear from you. 
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Whether you have questions about our AI technology, need support, 
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">support@lmt.ai</p>
                  <p className="text-gray-400">partnerships@lmt.ai</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Standard support: Mon-Fri, 9AM-6PM EST</p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-none"
